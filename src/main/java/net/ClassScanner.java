...
public class ClassScanner {
     ...
     * @return
     */
    public static Set<Class<?>> listAllSubclasses(String scanPackage,final Class<?> parent) {
        return getClasses(scanPackage, new ClassFilter() {
            @Override
            public boolean accept(Class<?> clazz) {
     ...
     * @return
     */
    public static <A extends Annotation> Set<Class<?>> listClassesWithAnnotation(String scanPackage, final Class<A> annotation) {
        return getClasses(scanPackage, new ClassFilter() {
            @Override
            public boolean accept(Class<?> clazz) {
